...
<html lang="en">
<head>
	<title>NetClothes Cadastro</title>
	<meta charset="UTF-8">
	...
	<div class="bg-contact3" style="background-image: url('/formreg/images/bg-01.jpg');">
		<div class="container-contact3">
			<div class="wrap-contact3">
				<form action="/acessorio/cadastro" method="post" class="contact3-form validate-form">
					...
					<div class="wrap-input3 validate-input" data-validate="Name is required">
						<input class="input3" type="text" name="descricao" placeholder="Descricao" required>
						<span class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input3" type="text" name="peso" placeholder="Peso" required>
						<span class="focus-input3"></span>
					</div>
					<div class="wrap-input3 validate-input" data-validate="Senha is required">
                        <input class="input3" type="text" name="valor" placeholder="Valor" required>
                        <span class="focus-input3"></span>
                    </div>
					<div class="wrap-input3 validate-input" data-validate="Telefone is required">
                        <input class="input3" type="text" name="imgProduto" placeholder="Imagem do Produto" required>
                        <span class="focus-input3"></span>
                    </div>
                    <div class="wrap-input3 validate-input" data-validate="CPF is required">
                        <input class="input3" type="text" name="marca" placeholder="Marca" required>
                        <span class="focus-input3"></span>
                    </div>
                    <div class="wrap-input3 validate-input" data-validate="CPF is required">
                        <input class="input3" type="text" name="modelo" placeholder="Modelo" required>
                        <span class="focus-input3"></span>
                    </div>
                    <div class="wrap-input3 validate-input" data-validate="CPF is required">
                        <input class="input3" type="text" name="tamanho" placeholder="Tamanho" required>
                        <span class="focus-input3"></span>
                    </div>
                    <div class="wrap-input3 validate-input" data-validate="CPF is required">
                        <input class="input3" type="text" name="tipo" placeholder="Tipo" required>
                        <span class="focus-input3"></span>
                    </div>
                    <div class="wrap-input3 validate-input" data-validate="CPF is required">
                        <input class="input3" type="text" name="cor" placeholder="Cor" required>
                        <span class="focus-input3"></span>
                    </div>
                    <div class="wrap-input3 validate-input" data-validate="CPF is required">
                        <input class="input3" type="text" name="material" placeholder="Material" required>
                        <span class="focus-input3"></span>
                    </div>
					<div class="container-contact3-form-btn">
						...
						<a class="link float-end" href="/calcados">Voltar a tela de calcados</a>
					</div>
				</form>
			</div>
		</div>
